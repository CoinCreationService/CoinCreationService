...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 15; // 15 days
...
const string strMessageMagic = "CoinCreationService Signed Message:\n";
...
int CMerkleTx::GetBlocksToMaturity() const
{
    if (!(IsCoinBase() || IsCoinStake()))
        return 0;
    return max(0, (nCoinbaseMaturity+3) - GetDepthInMainChain());
}
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CoinCreationService: check proof-of-stake block signature
...
// CoinCreationService: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoinCreationService", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CoinCreationService demo coin 21/11/2016";
        CTransaction txNew;
        txNew.nTime = 1479699202;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1479699202;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1275152;
        ...
        assert(block.hashMerkleRoot == uint256("0x982fe65a3ee1276786c383a3e9d466c33e42eac1394d5e2fe3adcfd7791f76e9"));
...
unsigned char pchMessageStart[4] = { 0x2c, 0x2a, 0xcc, 0x91 };
